  ...
  <section class="profile">
    <div class="profile__options">
      <div class="profile__options-item">
        ...
        <button @click="editPhoto" class="profile__options-button">
          Zmień zdjęcie <font-awesome-icon icon="pen-to-square" />
        </button>
      </div>
      ...
      <div class="profile__options-item">
        ...
        <button @click="resetStats" class="profile__options-button">
          Zresetuj statystyki <font-awesome-icon icon="rotate" />
        </button>
      </div>
    </div>
      ...
      <form class="profile__form-form form" @submit.prevent="updateAction">
        ...
        <div class="form-field form-field-submit">
          <button type="submit" class="form-field-submit-button">
            Zaktualizuj dane <font-awesome-icon icon="pen-to-square" />
          </button>
        </div>
      </form>
    </div>
